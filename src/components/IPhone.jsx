...
function Model(props) {
      ...
      return (
          <group {...props} dispose={null}>
                <mesh geometry={nodes['military_knife_Material_#90_0'].geometry} material={materials.Material_90} position={[0, 0.074, -0.006]} rotation={[-1.573, -0.459, -0.001]} scale={0.001} />
          </group>
      );
}
